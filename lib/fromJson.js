...
var undefinedValue = require('virtual-dom/vdom/undefined-value');
...
var hookProperties = require('./hookProperties');
...
function plainObjectFromJson(json, ctx) {
  ...
  for (var key in json) {
    var val = json[key];
    if(undefinedValue.isUndefined(val)) {
      val = undefined;
    }
